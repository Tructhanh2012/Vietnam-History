            ...
            <div className="article-list">
              <div className="article-item">
                <a href="https://example.com">
                  <img
                    src="/src/pages/profile/pic/phuoclong.png"
                    alt="Article 1"
                  />
                </a>
                <h5>
                ...
                <p>
                  Chiến dịch đường 14-Phước Long. Một phần của Chiến tranh Việt
                  Nam
                </p>
              ...
              <div className="article-item">
                <a href="https://example.com">
                  <img
                    src="/src/pages/profile/pic/bandong.jpg"
                    alt="Article 1"
                  />
                </a>
                <h5>
                  {" "}
                  <a href="https://example.com"> Trận Bản Đông năm 1971</a>
                </h5>

                <p>
                  Trận Bản Đông. Một phần của Chiến tranh Việt Nam. Thời gian: 8
                  tháng 2 – 20 tháng 3 năm 1971
                </p>
              ...
              <div className="article-item">
                <a href="https://example.com">
                  <img
                    src="/src/pages/profile/pic/viettrung.png"
                    alt="Article 1"
                  />
                </a>
                <h5>
                ...
                <p>
                  Vấn đề biên giới Việt-Trung thời Mạc phản ánh những hoạt động
                  quân sự - ngoại giao giữa nhà Mạc ở Việt Nam với nhà Minh
                </p>
              ...
              <div className="article-item">
                <a href="https://example.com">
                  <img
                    src="/src/pages/profile/pic/phancap.png"
                    alt="Article 1"
                  />
                </a>
                <h5>
                ...
                <p>
                  Phân cấp hành chính thời quân chủ Việt Nam được tính từ khi
                  Việt Nam giành được độc lập sau thời kỳ bắc thuộc đến khi
                  người Pháp xâm lược và chiếm đóng hoàn toàn Việt Nam (938 -
                  1886)
                </p>
            ...
            <div>
              <div className="article-list">
                <div className="article-item">
                  <a href="https://example.com">
                    <img
                      src="/src/pages/profile/pic/lanhtho.png"
                      alt="Article 1"
                    />
                  </a>
                  <h5>
                  ...
                  <p>
                    Lãnh thổ Việt Nam qua từng thời kỳ là sự biến đổi không gian
                    sinh tồn của người Việt, thể hiện bởi các triều đại chính
                    thống được công nhận. Nó mang tính chất phức tạp
                  </p>
                </div>
                <div className="article-item">
                  <a href="https://example.com">
                    <img
                      src="/src/pages/profile/pic/chuviet.png"
                      alt="Article 1"
                    />
                  </a>
                  <h5>
                  ...
                  <p>
                    Tiếng Việt là ngôn ngữ của người Việt và là ngôn ngữ chính
                    thức của Việt Nam. Trong lịch sử Việt Nam đã có ba loại văn
                    tự được dùng để ghi chép tiếng Việt là chữ Hán, chữ Nôm và
                    chữ quốc ngữ.{" "}
                  </p>
                </div>
                <div className="article-item">
                  ...
                  <p>
                    Vấn đề biên giới Việt-Trung thời Mạc phản ánh những hoạt
                    động quân sự - ngoại giao giữa nhà Mạc ở Việt Nam với nhà
                    Minh
                  </p>
                </div>
              </div>
            ...
            <div>
              <div className="article-list">
                <div className="article-item">
                  <a href="https://example.com">
                    <img
                      src="/src/pages/profile/pic/dienbienphu.png"
                      alt="Article 1"
                    />
                  </a>
                  <h5>
                ...
                <div className="article-item">
                  <a href="https://example.com">
                    <img
                      src="/src/pages/profile/pic/bachdang.png"
                      alt="Article 1"
                    />
                  </a>
                  <h5>
                    {" "}
                    <a href="https://example.com">
                      Chiến thắng sông Bạch Đằng 1288
                    </a>
                  </h5>
                  <p>Điểm:</p>
                  <p>Thời gian làm bài:</p>
