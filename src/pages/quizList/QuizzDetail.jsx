...
const QuizDetail = () => {
  ...
  return (
   ...
   <p class="card-text"> Điểm của câu:  </p>
         ...
         <div key={index} className="col-md-9 carddd border border-dark rounded">
         <div class="card-body">
  ...
  <Button type="primary" onClick={showModal}>
      ...
      <Modal title="Thông báo" open={isModalOpen} onOk={handleSubmit} onCancel={handleCancel}>
       <p>Các câu trả lời sẽ được lưu vào hệ thống, bạn có chắc chắn nộp bài</p>
      </Modal>
  </div>
   </div>
